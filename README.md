...
https://doi.org/10.1007/s40415-024-01033-8

## Data folder

- **pollen_data-mimosa.csv**: Literature data and new pollen morphology descriptions for _Mimosa_ taxa.
- **mimosa_tree-Vasconcelos2020.tre**: _Mimosa_ phylogenetic hypothesis from Vasconcelos et al. (2020).
- **Mimosa_tree_data-Vasconcelos2020.csv**: Information on _Mimosa_ phylogeny taxa provided by Vasconcelos et al. (2020).

## Output folder

- **data**: Intermediate files and raw results from the disparity analyses.
- **plots**: Figures showing the results of the disparity analyses and phylogenetic tree visualization.
- **tnrs**: Intermediate files from the Taxonomic Name Resolution Service

## Script folder

**analysis.R script**

**1. Section "Sampling Analysis"**
